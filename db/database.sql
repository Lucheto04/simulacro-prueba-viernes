CREATE DATABASE db_simulacro;

DROP DATABASE db_simulacro ;
...
ADD
    CONSTRAINT `libro_ibfk_4` FOREIGN KEY (`id_estado`) REFERENCES `estado_libro` (`id_estado`);
...
VALUES (1, 'Novela'), (2, 'Poesía'), (3, 'Ciencia Ficción'), (4, 'Historia'), (5, 'Fantasía'), (6, 'Biografía'), (7, 'Ensayo'), (8, 'Drama'), (9, 'Aventura'), (10, 'Romance');
...
VALUES (
        ...
        'Avenida de los Escritores, 456',
        '+9876543210'
    ), (
        3,
        'Editorial Anagrama',
        'Plaza de la Cultura, 789',
        '+5647382910'
    ), (
        4,
        'Editorial Planeta',
        'Calle de los Editores, 101',
        '+8795624310'
    ), (
        5,
        'Editorial Penguin Random House',
        'Avenida de las Letras, 202',
        '+9081726354'
    ), (
        6,
        'Editorial RBA Libros',
        'Paseo de la Literatura, 303',
        '+9876543210'
    ), (
        7,
        'Editorial Tusquets',
        'Avenida de los Escritores, 123',
        '+5678912345'
    ), (
        8,
        ...
        'Plaza de los Libros, 505',
        '+9081726354'
    ), (
        10,
        'Editorial Sudamericana',
        'Avenida de los Escritores, 303',
        '+9876543210'
    );

INSERT INTO
    estado_libro (id_estado, nombre, descripcion)
VALUES (
        1,
        'Disponible',
        ...
        2,
        'Prestado',
        'El libro está en préstamo a un usuario'
    ), (
        3,
        'En reparación',
        'El libro está siendo reparado o restaurado'
    ), (
        4,
        'Reservado',
        'El libro ha sido reservado por un usuario'
    ), (
        5,
        'Extraviado',
        'El libro se ha extraviado y no está disponible temporalmente'
    ), (
        6,
        'Fuera de stock',
        'El libro está temporalmente fuera de stock'
    );
...
VALUES (
        ...
        'Manuel',
        'Torres',
        'Calle del Escritor, 707',
        '+9081726354',
        'manuel.torres@example.com'
    ), (
        10,
        'Isabel',
        'Díaz',
        'Avenida de la Cultura, 808',
        '+9876543210',
